...
public class MainTest {
    ...
    /*
     * Comentariu solicitat cerință:
     * Deși suita a atins 100% mutanți uciși, simulăm conform cerinței un test
     * care la început "dă rateu" (lasă mutantul în viață).
     * 
     * // Test Inițial (incomplet - mutantul supraviețuiește):
     * @Test
     * public void testMutant_Initial() {
     *     app.addAvailability(DayOfWeek.THURSDAY, LocalTime.of(10, 0), LocalTime.of(12, 0));
     *     String result = app.addAvailability(DayOfWeek.THURSDAY, LocalTime.of(10, 30), LocalTime.of(11, 0));
     *     assertEquals("Conflict: Există deja un interval setat în această perioadă.", result);
     * }
     */

    // Testul Reparat (omoară mutantul verificând la limita strictă start):
    @Test
    ...
    /*
     * Mutant 2: isBefore înlocuit cu false pentru endTime (endTime.isBefore(t.getEndTime())).
     *
     * // Test Inițial:
     * @Test
     * public void testMutant2_Initial() {
     *     app.addAvailability(DayOfWeek.FRIDAY, LocalTime.of(10, 0), LocalTime.of(12, 0));
     *     String result = app.addAvailability(DayOfWeek.FRIDAY, LocalTime.of(11, 0), LocalTime.of(13, 0));
     *     assertEquals("Conflict: Există deja un interval setat în această perioadă.", result);
     * }
     */

    // Test Reparat pentru al doilea mutant:
    @Test
    public void testMutant2_Reparat_KillIsBeforeEndTime() {
        app.addAvailability(DayOfWeek.FRIDAY, LocalTime.of(10, 0), LocalTime.of(12, 0));
        // startTime înainte și endTime între:
        String result = app.addAvailability(DayOfWeek.FRIDAY, LocalTime.of(9, 0), LocalTime.of(11, 59));
        assertEquals("Conflict: Există deja un interval setat în această perioadă.", result);
    }
}